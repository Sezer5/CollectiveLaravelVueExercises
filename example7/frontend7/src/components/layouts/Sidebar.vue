<template>
  <div
    class="flex-shrink-0 p-3 bg-white shadow-sm border border-3 vh-100"
    style="width: 280px"
  >
    <a
      href="/"
        ...
        <div class="collapse" id="home-collapse" style="">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li
              ...
              :key="category.id"
              @click="productStore.fetchProductsByCategory(category.slug)"
            >
              <a href="#" class="link-dark rounded">{{ category.name }}</a>
            </li>
          </ul>
        </div>
      </li>
